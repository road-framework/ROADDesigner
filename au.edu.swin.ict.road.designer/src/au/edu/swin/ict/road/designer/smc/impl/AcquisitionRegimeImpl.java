...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Acquisition Regime</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link au.edu.swin.ict.road.designer.smc.impl.AcquisitionRegimeImpl#getSyncInterval <em>Sync Interval</em>}</li>
 *   <li>{@link au.edu.swin.ict.road.designer.smc.impl.AcquisitionRegimeImpl#getMode <em>Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AcquisitionRegimeImpl extends EObjectImpl implements AcquisitionRegime {
	/**
	 ...
	 * @generated
	 */
	protected AcquisitionRegimeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SmcPackage.Literals.ACQUISITION_REGIME;
	}
	...
	public void setSyncInterval(int newSyncInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmcPackage.ACQUISITION_REGIME__SYNC_INTERVAL, oldSyncInterval, syncInterval));
	}
	...
	public void setMode(Mode newMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmcPackage.ACQUISITION_REGIME__MODE, oldMode, mode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmcPackage.ACQUISITION_REGIME__SYNC_INTERVAL:
				return getSyncInterval();
			case SmcPackage.ACQUISITION_REGIME__MODE:
				return getMode();
		}
