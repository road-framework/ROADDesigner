 ...
 * @generated
 */
public class ContractRoleBIDCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ContractRoleBIDCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return SmcBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateContractRoleBID_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRoleBID(getTarget());
		}
