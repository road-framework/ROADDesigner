...
import au.edu.swin.ict.road.designer.smc.diagram.edit.policies.SmcTextSelectionEditPolicy;
 ...
 * @generated
 */
public class SMCNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				SmcVisualIDRegistry
						.getType(au.edu.swin.ict.road.designer.smc.diagram.edit.parts.SMCNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public SMCNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SmcTextSelectionEditPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof SmcTextSelectionEditPolicy) {
			((SmcTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof SmcTextSelectionEditPolicy) {
			((SmcTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SmcParserProvider
					.getParser(
							SmcElementTypes.SMC_2001,
							getParserElement(),
							SmcVisualIDRegistry
									.getType(au.edu.swin.ict.road.designer.smc.diagram.edit.parts.SMCNameEditPart.VISUAL_ID));
		}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), SmcEditPartFactory
