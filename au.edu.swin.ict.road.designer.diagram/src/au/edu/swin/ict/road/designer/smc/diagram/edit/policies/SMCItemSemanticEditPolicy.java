 ...
 * @generated
 */
public class SMCItemSemanticEditPolicy extends SmcBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SMCItemSemanticEditPolicy() {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (SmcVisualIDRegistry.getVisualID(node)) {
			case SMCSMCCompartmentEditPart.VISUAL_ID:
				for (Iterator cit = node.getChildren().iterator(); cit
						.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (SmcVisualIDRegistry.getVisualID(cnode)) {
