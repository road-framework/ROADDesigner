 ...
 * @generated
 */
public class SmcViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SystemEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& SmcVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SmcVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ContractRoleAIDEditPart.VISUAL_ID:
			return createContractRoleAID_4001(containerView, index, persisted,
					preferencesHint);
		case ContractRoleBIDEditPart.VISUAL_ID:
			return createContractRoleBID_4002(containerView, index, persisted,
					preferencesHint);
		case FactLinkEditPart.VISUAL_ID:
			return createFactLink_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case FactLink2EditPart.VISUAL_ID:
			return createFactLink_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case PlayerBindingEditPart.VISUAL_ID:
			return createPlayerBinding_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ExternalFactLinkEditPart.VISUAL_ID:
			return createExternalFactLink_4005(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
