...
/**
 * This is the item provider adapter for a {@link au.edu.swin.ict.road.designer.smc.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmcPackage.Literals.SYSTEM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmcPackage.Literals.SYSTEM__SMC);
			childrenFeatures.add(SmcPackage.Literals.SYSTEM__PLAYER);
		}
	...
	public String getText(Object object) {
		String label = ((au.edu.swin.ict.road.designer.smc.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(au.edu.swin.ict.road.designer.smc.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmcPackage.Literals.SYSTEM__SMC,
				 SmcFactory.eINSTANCE.createSMC()));

		newChildDescriptors.add
			(createChildParameter
				(SmcPackage.Literals.SYSTEM__PLAYER,
				 SmcFactory.eINSTANCE.createPlayer()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SmcPackage.Literals.SYSTEM__SMC ||
			childFeature == SmcPackage.Literals.SYSTEM__PLAYER;
