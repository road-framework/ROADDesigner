...
/**
 * This is the item provider adapter for a {@link au.edu.swin.ict.road.designer.smc.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmcPackage.Literals.OPERATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addReturnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_Return_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_Return_feature", "_UI_Operation_type"),
				 SmcPackage.Literals.OPERATION__RETURN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmcPackage.Literals.OPERATION__PARAMETER);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operation.class)) {
			case SmcPackage.OPERATION__NAME:
			case SmcPackage.OPERATION__RETURN:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SmcPackage.OPERATION__PARAMETER:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmcPackage.Literals.OPERATION__PARAMETER,
				 SmcFactory.eINSTANCE.createParameter()));
	}
