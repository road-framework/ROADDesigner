...
/**
 * This is the item provider adapter for a {@link au.edu.swin.ict.road.designer.smc.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addManagementResponsibilitiesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmcPackage.Literals.ROLE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmcPackage.Literals.ROLE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Management Responsibilities feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addManagementResponsibilitiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Role_ManagementResponsibilities_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Role_ManagementResponsibilities_feature", "_UI_Role_type"),
				 SmcPackage.Literals.ROLE__MANAGEMENT_RESPONSIBILITIES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmcPackage.Literals.ROLE__TASK);
			childrenFeatures.add(SmcPackage.Literals.ROLE__EXTERNAL_FACT_LINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SmcPackage.Literals.ROLE__TASK,
				 SmcFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(SmcPackage.Literals.ROLE__EXTERNAL_FACT_LINK,
				 SmcFactory.eINSTANCE.createExternalFactLink()));
	}
