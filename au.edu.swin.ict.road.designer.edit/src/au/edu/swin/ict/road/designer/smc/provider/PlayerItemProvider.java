...
/**
 * This is the item provider adapter for a {@link au.edu.swin.ict.road.designer.smc.Player} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmcPackage.Literals.PLAYER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_binding_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_binding_feature", "_UI_Player_type"),
				 SmcPackage.Literals.PLAYER__BINDING,
				 true,
				 false,
				 true,
				 null,
